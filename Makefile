...
pkgdatadir = $(datadir)/giella-moh
pkgincludedir = $(includedir)/giella-moh
pkglibdir = $(libdir)/giella-moh
pkglibexecdir = $(libexecdir)/giella-moh
...
CONFIG_CLEAN_FILES = giella-moh.pc \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/giella-moh.pc.in \
	$(top_srcdir)/build-aux/config.guess \
	$(top_srcdir)/build-aux/config.sub \
	$(top_srcdir)/build-aux/install-sh \
	$(top_srcdir)/build-aux/missing \
	$(top_srcdir)/devtools/check_analysis_regressions.sh.in \
	$(top_srcdir)/devtools/test_ospell-office_suggestions.sh.in \
	$(top_srcdir)/devtools/test_voikkospell_suggestions.sh.in \
	AUTHORS INSTALL README build-aux/config.guess \
...
ACLOCAL = ${SHELL} /Users/kazantsevaa/Software/giella/startup-langs/moh/build-aux/missing aclocal-1.15
ALT_ORTHS = 
ALT_WSS = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AREAS = 
AUTOCONF = ${SHELL} /Users/kazantsevaa/Software/giella/startup-langs/moh/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/kazantsevaa/Software/giella/startup-langs/moh/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/kazantsevaa/Software/giella/startup-langs/moh/build-aux/missing automake-1.15
AWK = gawk
BC = /usr/bin/bc
...
DEFAULT_ORTH = 
DEFAULT_WS = Latn
DEFS = -DPACKAGE_NAME=\"Giella\ moh\" -DPACKAGE_TARNAME=\"giella-moh\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"Giella\ moh\ 0.1\" -DPACKAGE_BUGREPORT=\"feedback@divvun.no\" -DPACKAGE_URL=\"http://divvun.no\" -DPACKAGE=\"giella-moh\" -DVERSION=\"0.1\"
DIALECTS = 
DIFFTOOL = /usr/bin/opendiff
DIVVUN_VALIDATE_SUGGEST = no
ECHO_C = \c
ECHO_N = 
ECHO_T = 
...
GIELLA_CORE = /Users/kazantsevaa/Software/giella/giella-core
GIELLA_CORE_VERSION = /Users/kazantsevaa/Software/giella/giella-core/scripts/gt-version.sh
GIELLA_LIBS = /Users/kazantsevaa/Software/giella/giella-libs
GIELLA_MAINTAINER = 
GIELLA_SHARED = /Users/kazantsevaa/Software/giella/giella-shared
GIELLA_TEMPLATES = 
GLANG = moh
GLANG2 = moh
GLANGUAGE = Mohawk
GTCORE = /Users/kazantsevaa/Software/giella/giella-core
GTCORESH = /Users/kazantsevaa/Software/giella/giella-core/scripts/gt-core.sh
GTLANG = moh
GTLANG2 = moh
GTLANGUAGE = Mohawk
GZIP = /usr/bin/gzip
...
HFST_MINIMIZE_SPELLER = /usr/local/bin/hfst-remove-epsilons $(HFST_FLAGS)                                          | /usr/local/bin/hfst-push-weights -p initial $(HFST_FLAGS)                                          | /usr/local/bin/hfst-determinize --encode-weights $(HFST_FLAGS)                                          | /usr/local/bin/hfst-minimize    --encode-weights 
...
JV = /usr/bin/java
LEXC = /Users/kazantsevaa/Software/xfst/bin/lexc
LIBOBJS = 
LIBS = 
LOOKUP = /Users/kazantsevaa/Software/xfst/bin/lookup
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/kazantsevaa/Software/giella/startup-langs/moh/build-aux/missing makeinfo
MKDIR_P = build-aux/install-sh -c -d
PACKAGE = giella-moh
PACKAGE_BUGREPORT = feedback@divvun.no
PACKAGE_NAME = Giella moh
PACKAGE_STRING = Giella moh 0.1
PACKAGE_TARNAME = giella-moh
PACKAGE_URL = http://divvun.no
PACKAGE_VERSION = 0.1
PATGEN = /opt/local/bin/patgen
PATH_SEPARATOR = :
...
STRIP = 
TAR = /usr/bin/tar
TWOLC = /Users/kazantsevaa/Software/xfst/bin/twolc
VERSION = 0.1
...
XFST = /Users/kazantsevaa/Software/xfst/bin/xfst
XZ = /opt/local/bin/xz
ZIP = /usr/bin/zip
abs_builddir = /Users/kazantsevaa/Software/giella/startup-langs/moh
abs_srcdir = /Users/kazantsevaa/Software/giella/startup-langs/moh
abs_top_builddir = /Users/kazantsevaa/Software/giella/startup-langs/moh
abs_top_srcdir = /Users/kazantsevaa/Software/giella/startup-langs/moh
am__leading_dot = .
...
install_sh = ${SHELL} /Users/kazantsevaa/Software/giella/startup-langs/moh/build-aux/install-sh
...
pdfdir = ${docdir}
pkgpyexecdir = ${pyexecdir}/giella-moh
pkgpythondir = ${pythondir}/giella-moh
prefix = /usr/local
...
$(am__aclocal_m4_deps):
giella-moh.pc: $(top_builddir)/config.status $(srcdir)/giella-moh.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
devtools/check_analysis_regressions.sh: $(top_builddir)/config.status $(top_srcdir)/devtools/check_analysis_regressions.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
devtools/test_ospell-office_suggestions.sh: $(top_builddir)/config.status $(top_srcdir)/devtools/test_ospell-office_suggestions.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
devtools/test_voikkospell_suggestions.sh: $(top_builddir)/config.status $(top_srcdir)/devtools/test_voikkospell_suggestions.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
