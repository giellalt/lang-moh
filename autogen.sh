...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_moh to login script."
...
# the current dir:
if   test x${GTLANG_moh} = x ; then
	echo "WARNING: The variable \${GTLANG_moh} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_moh} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_moh} has the value:"
	echo "  ${GTLANG_moh}"
