...
This directory contains source files for the Mohawk language morphology
...
-   <https://giellalt.uit.no/lang/moh/MohawkDocumentation.html>
    (analyser)
...
In order to compile and use Mohawk language morphology and dictionaries,
you need:
...
The Mohawk language sources can be acquired using [giella SVN
